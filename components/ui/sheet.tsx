...
// Slide-over drawer built on the same radix-ui Dialog primitive as dialog.tsx.
// Used for the mobile invention nav (side="left") and the 출원 서류 draft (side="right"),
// so small screens regain the panes that are hidden behind md:/lg: breakpoints.
